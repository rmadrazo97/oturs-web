	...
	//		echo "</pre>";
		...
		function render_field($field_params, $field_slug, $current_values, $in_the_bottom = false){
			...
			if ($field_params['type'] == 'text') {
				...
				?>
				<h4 class="wpallimport-add-on-options-title"><?php echo $field_params['name']; ?><?php if ( ! empty($field_params['tooltip'])): ?><a href="#help" class="wpallimport-help" title="<?php echo $field_params['tooltip']; ?>" style="position:relative; top: -1px;">?</a><?php endif; ?></h4>				
				<?php

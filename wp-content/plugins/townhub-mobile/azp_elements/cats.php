...
azp_add_element(
    'app_cats',
    array(
        'name'                    => __('Categories', 'townhub-mobile'),
        'category'                => 'Mobile App',
        ...
        'attrs'                   => array(
            ...
            array(
                ...
                'default'       => 'square',
                'value'         => array(
                    'square'    => __('Square', 'townhub-mobile'),
                    'circle'    => __('Circle', 'townhub-mobile'),
                    'carousel'  => __('Carousel', 'townhub-mobile'),
                    'grid'      => __('Grid', 'townhub-mobile'),
                    'squareimg'      => _x('Square with image icon','Element Option', 'townhub-mobile'),
                ),
            ),
            ...
            array(
                'type'       => 'text',
                'param_name' => 'cat_ids',
                'label'      => __('Categories IDs', 'townhub-mobile'),
                'desc'       => __('Enter Categories ids to include, separated by a comma (,). Leave empty to show all.', 'townhub-mobile' ),
                'default'    => '',
            ),
            array(
                'type'       => 'text',
                'param_name' => 'cat_ids_not',
                'label'      => __('Or Categories IDs to Exclude', 'townhub-mobile'),
                'desc'       => __( 'Enter Categories ids to include, separated by a comma (,).', 'townhub-mobile' ),
                'default'    => '',
            ),

    ...
    <div class="box-widget-item fl-wrap block_box" id="widget-rooms_new-booking">
        ...
        <div class="box-widget rooms-booking-wrap">
            <div class="box-widget-content">
                ...
                <div id="bookingrooms-app" class="rooms-booking-app" data-format="<?php _ex( 'DD/MM/YYYY', 'rooms booking date format', 'townhub-add-ons' ); ?>" price_based="night_person" min_nights="<?php echo esc_attr( $min_nights ); ?>" qtt_service="<?php echo esc_attr($quanity_lservices) ;?>" as_inquiry="<?php echo esc_attr($as_inquiry) ;?>" nonce="<?php echo wp_create_nonce('townhub-add-to-cart'); ?>"></div>

...
class CTH_Listing_Categories extends Widget_Base {
    ...
    */
    ...
    public function get_title() {
        return __( 'Listing Categories', 'townhub-add-ons' );
    }
    ...
    */
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_query',
            [
                'label' => __( 'Categories Query', 'townhub-add-ons' ),
            ]
        );
        ...
        $this->add_control(
            'cat_ids',
            [
                'label' => __( 'Select Categories to include (Leave empty for ALL)', 'townhub-add-ons' ),
        ...
        $this->add_control(
            'cat_ids_not',
            [
                'label' => __( 'Or Categories to exclude (Leave empty for ALL)', 'townhub-add-ons' ),
                'type' => Controls_Manager::SELECT2,
                'options' => townhub_addons_get_listing_categories_select2(),
                'multiple' => true,
                'label_block' => true,
        ...
        $this->add_control(
            'number',
            [
                'label' => __( 'Number of Categories to show', 'townhub-add-ons' ),
                'type' => Controls_Manager::NUMBER,
                'default' => '6',
                'description' => esc_html__("Number of Categories to show (0 for all).", 'townhub-add-ons'),
                'min'     => 0,
                'step'     => 1,
        ...
        $this->start_controls_section(
            'section_layout',
            [
                'label' => __( 'Categories Layout', 'townhub-add-ons' ),
            ]
        );
        ...
        $this->add_control(
            'items_width',
            [
                'label' => __( 'Categories Items Width', 'townhub-add-ons' ),
                'type' => Controls_Manager::TEXT,

                'label_block' => true,
                // 'default' => 'date',
                // 'separator' => 'before',
                'description' => esc_html__('Defined category width. Available values are x1(default),x2(x2 width),x3(x3 width), and separated by comma. Ex: x1,x1,x2,x1,x1,x1', 'townhub-add-ons')
            ]
        );
        ...
        $this->add_control(
            'count_child',
            [
                'label' => __( 'Count listings from child categories', 'townhub-add-ons' ),
                'description' => '',
                'type' => Controls_Manager::SWITCHER,
                'default' => '0',
                'label_on' => _x( 'Yes', 'On/Off', 'townhub-add-ons' ),
                    ...
                    <div id="listing_cat-<?php echo esc_attr( $term->term_id );?>" class="<?php echo esc_attr( $item_cls ); ?>">
                        <div class="grid-tax-holder">
                            <div class="grid-tax-inner">
                                ...
                                <a href="<?php echo townhub_addons_get_term_link( $term->term_id, 'listing_cat' ); ?>" class="d-gr-sec lcat-card-link"></a>
                                ...
                                <div class="listing-item-grid_title">
                                    <h3><a href="<?php echo townhub_addons_get_term_link( $term->term_id, 'listing_cat' ); ?>"><?php echo esc_html($term->name); ?></a></h3>

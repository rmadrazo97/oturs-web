        ...
        <div class="listsearch-options fl-wrap" id="lisfw" >
            <div class="container">
                <div class="listsearch-header fl-wrap">
                    <?php 
                    $search_term = single_term_title( '', false );
                    if( isset($_GET['search_term']) && $_GET['search_term'] != '' ) $search_term = esc_html( $_GET['search_term'] );
                    ?>
                    <h1 class="head-sec-title"><?php printf( esc_html__( 'Results for: %s', 'townhub-add-ons' ), '<span>' . $search_term . '</span>' ); ?></h1>
                ...
                <div class="listing-term-desc"><?php echo term_description( ) ?></div>
                <?php townhub_addons_get_template_part('templates/filter_form'); ?>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="listsearch-header fl-wrap listsearch-header-sidebar">
                            <h1 class="head-sec-title"><?php printf( esc_html__( 'Results for: %s', 'townhub-add-ons' ), '<span>' . single_term_title( '', false ) . '</span>' ); ?></h1>
                            <div class="listing-view-layout">
                                <ul>
                                    <li><a class="grid<?php if(townhub_addons_get_option('listings_grid_layout')=='grid') echo ' active';?>" href="#"><i class="fa fa-th-large"></i></a></li>
                                    <li><a class="list<?php if(townhub_addons_get_option('listings_grid_layout')=='list') echo ' active';?>" href="#"><i class="fa fa-list-ul"></i></a></li>

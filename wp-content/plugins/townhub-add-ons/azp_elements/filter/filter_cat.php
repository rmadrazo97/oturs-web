...
azp_add_element(
    'filter_cat',
    array(
        'name'                    => __('Category Filter', 'townhub-add-ons'),
        ...
        'attrs'                   => array(
            ...
            array(
                ...
                'desc'        => '',
                'default'     => '',
                'value'       => townhub_addons_lcats_options(),
                'multiple'    => true,
                'show_toggle' => true,
            ),
            array(
                ...
                'show_in_admin' => true,
                'label'         => __('Child categories level', 'townhub-add-ons'),
            ...
            array(
                ...
                // 'show_in_admin' => true,
                'label'         => __('Allow select multiple categories?', 'townhub-add-ons'),
                'desc'          => '',
                'default'       => 'no',
                'value'         => array(

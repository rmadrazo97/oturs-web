...
azp_add_element(
    'lcoupon',
    array(
        'name'                    => __('Coupon Code', 'townhub-add-ons'),
        ...
        'attrs'                   => array(
            ...
            array(
                ...
                'show_in_admin'         => true,
                'label'                 => __('Display coupon','townhub-add-ons'),
                'desc'                  => __('Which coupon you want to show in this widget? 1 for first item.','townhub-add-ons'),
                'default'               => '1',
            ),
            array(
                'type'        => 'checkbox',

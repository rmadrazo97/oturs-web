...
azp_add_element(
    'lsimilar_slider',
    array(
        'name'                    => __('Similar Listings - Slider', 'townhub-add-ons'),
        ...
        'attrs'                   => array(
            ...
            array(
                ...
                "desc"       => esc_html__("The format is: screen-size:number-items-display,larger-screen-size:number-items-display. Ex: 850:1,1270:2,1650:3,2560:4", 'townhub-add-ons'),
                "default"    => "850:1,1270:2",
            ),

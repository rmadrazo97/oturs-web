...
if (!class_exists('ReduxFramework_image_url')) {
    class ReduxFramework_image_url
    {
        ...
        public function render()
        {
            ...
            echo '<fieldset id="' . $this->field['id'] . '" class="redux-image-url-container" data-id="' . $this->field['id'] . '">';
                ...
                echo '<div class="form-field media-field-wrap">';
                    ...
                    echo '<input type="text" id="' . $this->field['id'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" class="' . $imgclass . '_url input-url" value="' . $this->value . '">';
